...
def generate_dataset_spheroid(shape, N_data, a, b, c,
    ...
    while n_accepted < N_data:
        ...
        #     f"out/ellipsoids{index}.vtk", 
        #     [boundary1, boundary2], 
        #     [source1, source2]
        # )

        # Multiplying by scalar since magnitude of velocity was too small
        # Should result in unit velocity on sphere. 
